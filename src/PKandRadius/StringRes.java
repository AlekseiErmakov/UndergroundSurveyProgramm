...
public interface StringRes {
    ...
    CLEARBL="Очистить Базовую Линию",
    SAVERS="Сохранить результат",
    SAVEBL="Сохранить Базовую Линию",
    IMPORTPOINTS="Импортировать точки",
    IMPORTBL="Импортировать Базовую Линию";

    String ProgName ="Расчет параметров съемочных точек на прямой";
